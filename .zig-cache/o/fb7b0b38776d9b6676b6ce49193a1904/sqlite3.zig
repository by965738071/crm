...
pub const struct_sqlite3_stmt = opaque {
    ...
    pub const sqlite3_carray_bind_v2 = __root.sqlite3_carray_bind_v2;
    ...
    pub const v2 = __root.sqlite3_carray_bind_v2;
...
pub extern fn sqlite3_result_text64(?*sqlite3_context, z: [*c]const u8, n: sqlite3_uint64, ?*const fn (?*anyopaque) callconv(.c) void, encoding: u8) void;
...
pub const struct_sqlite3_str = opaque {
    ...
    pub const sqlite3_str_free = __root.sqlite3_str_free;
    ...
    pub const sqlite3_str_truncate = __root.sqlite3_str_truncate;
    ...
    pub const free = __root.sqlite3_str_free;
    ...
    pub const truncate = __root.sqlite3_str_truncate;
...
pub extern fn sqlite3_str_free(?*sqlite3_str) void;
...
pub extern fn sqlite3_str_truncate(?*sqlite3_str, N: c_int) void;
...
pub extern fn sqlite3_carray_bind_v2(pStmt: ?*sqlite3_stmt, i: c_int, aData: ?*anyopaque, nData: c_int, mFlags: c_int, xDel: ?*const fn (?*anyopaque) callconv(.c) void, pDel: ?*anyopaque) c_int;
...
pub const va_start = @compileError("unable to translate macro: undefined identifier `__builtin_va_start`"); // /opt/homebrew/Cellar/zig-dev/0.17.0-dev.2125+0d600e488/lib/zig/compiler/aro/include/stdarg.h:12:9
pub const va_end = @compileError("unable to translate macro: undefined identifier `__builtin_va_end`"); // /opt/homebrew/Cellar/zig-dev/0.17.0-dev.2125+0d600e488/lib/zig/compiler/aro/include/stdarg.h:14:9
pub const va_arg = @compileError("unable to translate macro: undefined identifier `__builtin_va_arg`"); // /opt/homebrew/Cellar/zig-dev/0.17.0-dev.2125+0d600e488/lib/zig/compiler/aro/include/stdarg.h:15:9
pub const __va_copy = @compileError("unable to translate macro: undefined identifier `__builtin_va_copy`"); // /opt/homebrew/Cellar/zig-dev/0.17.0-dev.2125+0d600e488/lib/zig/compiler/aro/include/stdarg.h:18:9
pub const va_copy = @compileError("unable to translate macro: undefined identifier `__builtin_va_copy`"); // /opt/homebrew/Cellar/zig-dev/0.17.0-dev.2125+0d600e488/lib/zig/compiler/aro/include/stdarg.h:22:9
pub const __GNUC_VA_LIST = @as(c_int, 1);
pub const SQLITE_EXTERN = @compileError("unable to translate C expr: unexpected token 'extern'"); // zig-pkg/zqlite-0.0.1-RWLaYz49nABcCXlOV690EXRLoexKyFDB9lCr5rsYfMQf/lib/sqlite3.h:72:10
...
pub const SQLITE_VERSION = "3.53.0";
pub const SQLITE_VERSION_NUMBER = __helpers.promoteIntLiteral(c_int, 3053000, .decimal);
pub const SQLITE_SOURCE_ID = "2026-04-09 11:41:38 4525003a53a7fc63ca75c59b22c79608659ca12f0131f52c18637f829977f20b";
pub const SQLITE_SCM_BRANCH = "trunk";
pub const SQLITE_SCM_TAGS = "release major-release version-3.53.0";
pub const SQLITE_SCM_DATETIME = "2026-04-09T11:41:38.498Z";
...
pub const SQLITE_DBCONFIG_FP_DIGITS = @as(c_int, 1023);
pub const SQLITE_DBCONFIG_MAX = @as(c_int, 1023);
...
pub const SQLITE_LIMIT_PARSER_DEPTH = @as(c_int, 12);
...
pub const SQLITE_PREPARE_FROM_DDL = @as(c_int, 0x20);
...
pub const SQLITE_UTF8_ZT = @as(c_int, 16);
...
pub const SQLITE_TESTCTRL_ATOF = @as(c_int, 34);
